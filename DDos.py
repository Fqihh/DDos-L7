...
def help():
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" Thanks for using DDOS-L7.               "+Fore.LIGHTGREEN_EX+"║\n")
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"github   "+Fore.LIGHTGREEN_EX+"|"+Fore.LIGHTWHITE_EX+" https://github.com/Fqihh/DDos-L7            "+Fore.LIGHTGREEN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def infoattack():
...
def title():
    stdout.write("                                                                                          \n")
    stdout.write("                   "+Fore.LIGHTWHITE_EX  +"_____________________________________                 \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"_____________________________________                 \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +" Github https://github.com/Fqihh/DDos-L7          \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"         Copy From Cutipu                \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"_____________________________________                \n")
    stdout.write("                   "+Fore.LIGHTGREEN_EX  +"_____________________________________                \n")
    stdout.write("             "+Fore.LIGHTGREEN_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTGREEN_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    ...
    stdout.write("             "+Fore.LIGHTGREEN_EX+"║ "+Fore.LIGHTWHITE_EX   +"       DDOS by Fq "+Fore.LIGHTGREEN_EX  +"          ║\n")
